...
@implementation MarketDeatilViewController
...
-(void)initTableSkin
{
    ...
    NSArray *nibs = [[NSBundle mainBundle]loadNibNamed:@"MarketHeadView" owner:nil options:nil];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    if(!self.headView)
    {
        NSArray *nib = [[NSBundle mainBundle]loadNibNamed:@"MarketBuyView" owner:self options:nil];
