...
- (void)initValues
{
    ...
    UIImageView* bgview = [[UIImageView alloc] initWithImage:[UIImage resizedImage:@"common_card_bottom_background.png"]];
    bgview.frame = CGRectMake(0, 0, 1000, kHeightOfTopScrollView);
