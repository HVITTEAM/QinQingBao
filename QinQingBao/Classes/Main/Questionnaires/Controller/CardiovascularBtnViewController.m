//
//  CardiovascularBtnViewController.m
//  QinQingBao
//
...
@interface CardiovascularBtnViewController ()
...
@implementation CardiovascularBtnViewController
...
-(void)toNextVC
{
    ...
    if (nextQuestionId >= 4 && nextQuestionId <= 8) {
        CardiovascularBtnViewController *nextQuestionBtnVC = [[CardiovascularBtnViewController alloc] init];
