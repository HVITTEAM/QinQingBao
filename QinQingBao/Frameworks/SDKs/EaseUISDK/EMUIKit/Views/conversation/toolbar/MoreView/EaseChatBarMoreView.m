...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    [_photoButton setImage:[UIImage imageNamed:@"图片"] forState:UIControlStateHighlighted];
...
//    [_scrollview addSubview:_locationButton];
    ...
    [_takePicButton setImage:[UIImage imageNamed:@"拍照"] forState:UIControlStateNormal];
    [_takePicButton setImage:[UIImage imageNamed:@"拍照"] forState:UIControlStateHighlighted];
